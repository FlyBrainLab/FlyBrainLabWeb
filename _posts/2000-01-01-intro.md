...
<p align="right">
FlyBrainLab provides an environment where computational researchers can present configurable, executable neural circuits and experimental scientists can interactively explore circuit structure and function ultimately leading to biological validation.<br> <br>

<a href="https://www.biorxiv.org/content/10.1101/2020.06.23.168161v1"><button type="button" class="btn btn-outline-info">Preprint</button></a>
